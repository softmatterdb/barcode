...
#     # Create all tabs
#     # home_frame = create_home_frame(notebook, config, input_config)
...
#     root.geometry("800x600")  # give it a size so it's visible
#     create_home_frame(root)
#     root.mainloop()
    ...
    # create_home_frame(scrollable_frame, gui_config, gui_input_config)
